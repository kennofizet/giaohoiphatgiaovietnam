...
<div class="panel panel-default">
  <form class="w3-container w3-card-4" id="form_admin_official_create" action="{{route('api.admin.official.create')}}" method="POST">
  {{csrf_field()}}
  	<table class="table table-striped table-bordered table-hover">
  		<tbody>
  			<tr>
  				<th>Mã số thẻ</th>
  				<td colspan="2">
  					<input class="w3-input w3-border-0" type="text" name="card_number">
  				</td>
  			</tr>
  			<tr>
  				<th>Họ tên *</th>
  				<td>
  					<input class="w3-input w3-border-0" type="text" name="name">
  				</td>
            ...
            <div class="text-left">
              ...
              <div class="file-upload-wrapper">
                  ...
                  <input type="text" disabled placeholder="Tải tại đây" class="file-upload-text" />
              </div>
            </div>
  				</td>
  			</tr>
  			<tr>
  				<th>Pháp Danh</th>
  				<td>
  					<input class="w3-input w3-border-0" type="text" name="alias">
  				</td>			
  			</tr>
  			<tr>
          ...
          <div class="modal fade" id="adminOfficialRedirectCategoryModal" tabindex="-1" role="dialog" aria-labelledby="adminOfficialRedirectCategoryModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
  			...
  			<tr>
  				<th>Ngày sinh</th>
  				<td colspan="2">
  					<input class="w3-input w3-border-0" type="text" name="date_of_birth">
  				</td>
  			</tr>
  			<tr>
  				<th>Số CMND</th>
  				<td colspan="2">
  					<input class="w3-input w3-border-0" type="text" name="cmnd">
  				</td>
  			</tr>
  			<tr>
          ...
          <div class="modal fade" id="adminOfficialRedirectPositionModal" tabindex="-1" role="dialog" aria-labelledby="adminOfficialRedirectPositionModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
              ...
              <option value="{{$detail_position->id}}">{{$detail_position->name}}</option>
              @endforeach
            </select>
  				</td>
  			</tr>
  			<tr>
  				<th>Đc thường trú</th>
  				<td colspan="2">
  					<input class="w3-input w3-border-0" type="text" name="address">
  				</td>
  			</tr>
  			<tr>
...
<script type="text/javascript">
  $('#form_admin_official_create').on('submit',function (e) {
    e.preventDefault();
    $('.mess-name').css('display','none');
      ...
      $.ajax({
        url:"{{route('api.admin.official.create')}}",
        method:"POST",
