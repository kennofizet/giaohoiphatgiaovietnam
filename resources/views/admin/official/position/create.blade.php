...
@section('content')
<form class="w3-container w3-card-4" id="form_admin_official_position_create" action="{{route('api.admin.official.position.create')}}" method="POST">
	{{csrf_field()}}
	<br>
	<p>      
		<label class="w3-text-grey">Tên chức vụ *</label><span class="mess-name" style="margin-left: 5px;color: red;display: none;">Vui lòng nhập tên</span>
...
<script type="text/javascript">
	$('#form_admin_official_position_create').on('submit',function (e) {
    e.preventDefault();
    $('.mess-name').css('display','none');
      ...
      $.ajax({
        url:"{{route('api.admin.official.position.create')}}",
        method:"POST",
        ...
        success:function(data){
          if (data.message === "success") {
              ...
              $('#form_admin_official_position_create').trigger("reset");
